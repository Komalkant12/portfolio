      ...
      <div className="flex flex-col lg:flex-row lg:ml-20 lg:gap-36">
        <div className="mb-5 lg:mb-0">
            ...
            <div className="flex flex-col gap-2">
                ...
                <a href="mailto:-komalkantdeshmukh112@gmail.com"
                  className="text-white font-mono underline text-lg lg:text-2xl">
                    komalkantdeshmukh112@gmail.com
                    </a>

                <a href="tel:+910123456789"
                  className="text-white font-mono underline text-lg lg:text-2xl">
                    +91 8224024253
                    </a>
            </div>
        ...
        <div>
          <form className="flex flex-col p-3">
            <input
              ...
              className="bg-transparent p-3 outline-none border focus:border-blue-500 focus:pl-8 transition-all duration-100 rounded-lg border-white gradient-text font-mon text-lg lg:text-2xl  mb-5 lg:mb-10 w-full lg:w-[30vw]"
            />
            <input
              type="email"
              name="email"
