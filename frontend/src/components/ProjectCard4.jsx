...
const ProjectCard = () => {
  return (
    ...
    <div className='h-90% w-[320px] md:w-[320p] border-2 border-gray-200 border-opacity-60 rounded-2xl overflow-clip lg:overlow-hidden hover:shadow-md lg:hover:scale-105 transition-all backdrop-blur-3xl shadow-xl'>
      <a href="">
        <img src={Project5} alt="QuickMail"   className="lg:h-48 h-[200px] w-full object-cover object-center" />
      </a>
       <div className='p-4 flex flex-col lg:gap-3'>
        <h2 className="tracking-widest text-2xl text-white" >TinDog</h2>
         <h1 className='text-lg ld:text-xl font-600 text-gray-300'>
         TinDog basically a Dog portfolio is fully responsive frontend  webpage designed
          using HTML , CSS and bootstrap. I created this page while learning and practice the CSS element and bootstrap .
        </h1>
